...
const EditProject = () => {
  ...
  const fetchProject = async () => {
    try {
      ...
      setServerError('Error al cargar proyecto');
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await api.put(`/projects/${id}`, finalData);
      setSuccessMessage('Proyecto actualizado exitosamente!');
      setTimeout(() => {
        navigate('/dashboard');
      }, 1500);
    } catch (error) {
      setServerError(error.response?.data?.message || 'Error al actualizar proyecto');
    }
  };
  ...
  return (
    <div className="auth-container">
      <div className="auth-card">
        <h1 className="pixel-title">Editar Proyecto</h1>
